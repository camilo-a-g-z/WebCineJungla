        ...
        <div class="container"><a class="navbar-brand logo" href="inicio.html" style="font-family: Aclonica, sans-serif;font-size: 30px;color: var(--bs-body-bg);"><strong>Cine Jungla</strong></a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navbarNav"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item"><a class="nav-link active" href="confiteria.html">Confitería</a></li>
        ...
        <section class="portfolio-block projects-cards" style="padding-top: 40px;padding-bottom: 60px;">
            <div class="container">
                <div class="heading" style="margin-bottom: 28px;">
                    <h2 style="font-size: 45px;font-family: Aclonica, sans-serif;margin-bottom: 0px;padding-bottom: 0px;">ConfiterÃ­a</h2>
                ...
                <div class="row">
                    <div class="col" style="border: 2px solid rgb(180,182,186);padding: 8px;margin-left: 4px;margin-bottom: 4px;margin-right: 4px;margin-top: 4px;"><img style="width: 200px;height: 240px;">
                        <h1>Producto</h1>
                        <p>Precio</p><button class="btn btn-primary border rounded-pill" type="button" style="width: 155px;height: 38px;margin-top: 0px;margin-bottom: 5px;margin-left: 37px;padding: 0px 0px;font-size: 16px;font-family: Aldrich, sans-serif;text-align: center;background: rgb(194,23,0);border: 2px solid rgb(180,182,186);">Comprar</button>
                    </div>
                    <div class="col" style="border: 2px solid rgb(180,182,186);padding: 8px;margin-left: 4px;margin-bottom: 4px;margin-right: 4px;margin-top: 4px;"><img style="width: 200px;height: 240px;">
                        <h1>Producto</h1>
                        <p>Precio</p><button class="btn btn-primary border rounded-pill" type="button" style="width: 155px;height: 38px;margin-top: 0px;margin-bottom: 5px;margin-left: 37px;padding: 0px 0px;font-size: 16px;font-family: Aldrich, sans-serif;text-align: center;background: rgb(194,23,0);border: 2px solid rgb(180,182,186);">Comprar</button>
