        ...
        <section class="portfolio-block hire-me" style="padding-top: 40px;padding-bottom: 60px;">
            <div class="container">
                ...
                <form action="LoginEmpleado" method="post" style="padding-top: 30px;padding-bottom: 30px;">
                    <div class="mb-3"><label class="form-label" for="email" style="font-family: Aldrich, sans-serif;font-size: 24px;">Correo electrónico</label><input class="form-control" type="text" id="correo" name="correo" style="font-family: Aldrich, sans-serif;height: 45px;"></div>
