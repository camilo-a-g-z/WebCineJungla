...
<body>
                ...
                <ul class="navbar-nav ms-auto">
                    <form action="ShowUserInfo" method="post">
                        <div id="info" style="display:none">
                            <input id="idCliente" name="idEmpleado" type="text" value="<%out.println(idEmpleado);%>">
                        </div>
    ...
    <main class="d-inline-flex page cv-page">
        ...
        <div class="d-table-cell group" style="margin-top: 25px;">
            ...
            <p class="text-break">Funcion: Día: </p>
            <p class="text-break">Escoja sus sillas (guiese por la imagen a la derecha):</p>
            <form method="post" action="SeleccionarConfiteriaE">
                <div id="info" style="display:none">
