                        ...
                        <div class="card shadow">
                            ...
                            <div class="card-body">
                                <form class="card-link" action="RedirectFuncionesAdd">
                                    ...
                                    <button class="btn btn-primary border rounded-pill" type="submit" style="background: rgb(194,23,0);font-family: Aldrich, sans-serif;width: 250px;height: 38px;">Añadir funciones</button>
                                </form>
