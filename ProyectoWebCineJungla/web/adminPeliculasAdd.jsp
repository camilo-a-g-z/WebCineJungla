                            ...
                            <div class="card-body">
                                <div class="p-5">
                                    ...
                                    <form class="d-inline user">
                                        ...
                                        </div><a href="adminPeliculas.html"><button class="btn btn-primary border rounded-pill" type="button" style="background: rgb(194,23,0);font-family: Aldrich, sans-serif;width: 180px;height: 38px;">Añadir película</button></a>
                                        <hr>
                                    </form>
