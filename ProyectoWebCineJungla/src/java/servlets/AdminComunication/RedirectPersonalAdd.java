 ...
 * @author USER
 */
public class RedirectPersonalAdd extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            resRol = DBRol.getRoles();
            request.getSession().setAttribute("rol", resRol);

            response.sendRedirect("adminPersonalAdd.jsp?idEmpleado=" + empleado);
        } catch (Exception e) {
