 ...
 * @author User
 */
public class DecidirSillasE extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
           ...
           res2 = DBc.getEmpleadoById(Integer.parseInt(request.getParameter("idEmpleado")));
           res2.next();
           ...
           response.sendRedirect("funcionFinalE.jsp");
        }catch(Exception e){
